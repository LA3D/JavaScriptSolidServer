...
export const FIXED_SUFFIXES = [
  { suffix: '/.well-known/lws-storage', name: 'storage-description', description: 'START HERE — the LWS server index (type:ServerIndex): every storage this pod hosts, each pointing at its own per-storage description (type:Storage, at storageDescription). Vocab/context locations are in pod-info.', mimeType: 'application/lws+json' },
